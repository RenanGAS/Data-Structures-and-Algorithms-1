...
int lista_posicao(Lista* l, TipoElemento elemento){
    ...
    No* aux = l->inicio;
    while(aux != NULL){
        if(strcmp(elemento, aux->dado)==0) return pos;
        pos++;
        aux = aux->prox;
    }
    return -1;  
